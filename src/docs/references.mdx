...
<ul>
<li>3.2.1 Integrated decision-making is supported by enterprise governance, planning and reporting;</li>
...
<li>3.2.4 Workforce capacity and capability development is supported.</li>
</ul>
</div>
