...
3.2.1
Integrated decision-making is supported by enterprise governance, planning and reporting;
3.2.2
Service delivery, business and program innovation are enabled by technology and data;
3.2.3
Service design and delivery is client-centric by design; and
3.2.4
Workforce capacity and capability development is supported.
